 ...
 *   https://datatables.net/download/#bs5/dt-2.2.1/fc-5.0.4/fh-4.0.1/r-3.0.3/rg-1.5.1
 *
 * Included libraries:
 *   DataTables 2.2.1, FixedColumns 5.0.4, FixedHeader 4.0.1, Responsive 3.0.3, RowGroup 1.5.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.2.1/fc-5.0.4/fh-4.0.1/r-3.0.3/rg-1.5.1",
